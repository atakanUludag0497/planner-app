...
//import TicTacToe from './widgets/TicTacToeWidget';
...
function App() {
 const [widgets, setWidgets] = useState([
  ...
  { component: <MyCustomWidget />, area: 'main-widget', name: "Location"},
  { component: <ReminderListWidget />, area: 'left-widget', name: "Reminder Notes"},
  //{ component: <TicTacToe />, area: 'left-widget', name: "Tic-Tac-Toe"},
  //{ component: <LocationWidget />, area: 'main-widget', name: "Location"},
  //{ id: new Date().getTime(), component: <TicTacToe />, area: 'left-widget', name: "Tic-Tac-Toe"},
  //{ id: new Date().getTime(), component: <LocationWidget />, area: 'main-widget', name: "Location"},
 ])
